...
def twoBoolEvaluate(bool_1: bool, bool_2: bool, outcomes: tuple):
...
def numberGrab(string, index):
	...
	while (
		index + number_length < len(string)
		and string[index : index + number_length + 1].isdigit()
	):
		number_length += 1
...
def dictAddKeyVal(dic: dict, seq):
	dic[seq[0]] = seq[1]
